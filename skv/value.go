...
const (
	...
	value_ns_uint8    uint8 = 2
	value_ns_uint16   uint8 = 3
	value_ns_uint32   uint8 = 4
	value_ns_uint64   uint8 = 5
...
func (v ValueUint) Uint8() uint8 {
	return uint8(v.Uint64())
}

func (v ValueUint) Uint16() uint16 {
	return uint16(v.Uint64())
}

func (v ValueUint) Uint32() uint32 {
	return uint32(v.Uint64())
}

func (v ValueUint) Uint64() uint64 {
...
func ValueEncode(value interface{}, encode ValueEncoder) ([]byte, error) {
	...
	case uint64:
		...
		/*
			case bool:
				if value.(bool) {
					enc_value = []byte{value_ns_uint8, 1}
				} else {
					enc_value = []byte{value_ns_uint8, 0}
				}
		*/
